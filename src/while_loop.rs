...
impl WhileLoop {
    #[inline]
    pub fn new(context: Context, condition: Expression, body: Vec<Instruction>) -> WhileLoop {
        WhileLoop {
            context,
            condition,
            body,
    ...
    pub fn eval_condition(
        ...
        match self.condition.exec(exec_session, parsed_session) {
            Ok(return_value) => {
                let value =
    ...
    pub fn exec(
        ...
        let mut condition_result = self.eval_condition(exec_session, parsed_session)?;
        ...
        'main_loop: while condition_result != false {
            ...
            condition_result = self.eval_condition(exec_session, parsed_session)?;
        }
